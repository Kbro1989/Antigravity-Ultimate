/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0832b9dfe4e49020a68d59f4be41c480)
// Runtime types generated with workerd@1.20251210.0 2026-01-06 nodejs_compat
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("./src/index");
        durableNamespaces: "SessionAgent" | "Collaboration" | "SessionDO" | "MetabolismDO";
    }
    interface Env {
        CACHE: KVNamespace;
        KV: KVNamespace;
        ...
        SESSION_AGENT: DurableObjectNamespace<import("./src/index").SessionAgent>;
        COLLABORATION_SERVER: DurableObjectNamespace<import("./src/index").Collaboration>;
        SESSION_DO: DurableObjectNamespace<import("./src/index").SessionDO>;
        METABOLISM_DO: DurableObjectNamespace<import("./src/index").MetabolismDO>;
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_HOST" | "BRIDGE_ID" | "CLOUDFLARE_EMAIL" | "CLOUDFLARE_API_KEY">> { }
}
declare module "*.glsl" {
    const value: string;
