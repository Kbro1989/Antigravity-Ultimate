...
import { augmentThreeJsFloorMaterial, ParsedMaterial, augmentZOffsetMaterial, ob3ModelToThree, modifyMesh, applyMaterial, getAttributeBackingStore } from "./modelutils"; import { ThreejsSceneCache, EngineCache } from "./enginecache";
...
function _deprecated_modifyMesh(mesh: ModelMeshData, mods: ModelModifications) {
